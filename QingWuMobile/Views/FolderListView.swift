...
private enum MobileFolderAccessError: LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .cannotRead:
            return "QingWu can't read this folder. Open Files and confirm the cloud provider exposes it."
        case .cannotWrite:
            return "QingWu can't write to this folder. Pick a writable folder or enable offline access in the cloud app."
        }
    }
}
