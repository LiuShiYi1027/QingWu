...
struct SettingsView: View {
    ...
    private static let repoURL = URL(string: "https://github.com/liushiyi1027/QingWu")
    private static let issuesURL = URL(string: "https://github.com/liushiyi1027/QingWu/issues/new")
    ...
    private var librarySection: some View {
        Section {
            ...
            Text("QingWu reads and writes Markdown files in this folder. iCloud Drive or your cloud drive app keeps it in sync with Mac.")
        }
    }
