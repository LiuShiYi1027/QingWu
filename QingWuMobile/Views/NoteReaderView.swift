...
/// `qingwu-asset` scheme. The reader loads notes with `loadHTMLString`,
...
/// bytes from disk.
enum LocalAssetURL {
    static let scheme = "qingwu-asset"
...
/// to the reader as `qingwu-bundle:///<name>`. `loadHTMLString` grants no
...
final class BundleAssetSchemeHandler: NSObject, WKURLSchemeHandler {
    static let scheme = "qingwu-bundle"
...
/// Serves `qingwu-asset://` subresource requests from disk. Registered on
